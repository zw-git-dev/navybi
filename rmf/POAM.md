...
| 8 | No configuration hardening baseline (host, runtime, application server) | SAR #8, SSP CM-6 | Low (as-built); Moderate (network-exposed) | Apply a hardening checklist before network-facing deployment | Engineering time; a hardening standard to apply | TBD | TBD | Open |
